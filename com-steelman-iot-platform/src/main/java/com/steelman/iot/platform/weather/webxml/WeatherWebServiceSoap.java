...
public interface WeatherWebServiceSoap {
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetSupportProvinceResponse")
    @WebResult(name = "getSupportProvinceResult", targetNamespace = "http://WebXml.com.cn/")
    public com.steelman.iot.platform.weather.webxml.ArrayOfString getSupportProvince()
;
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetWeatherbyCityNameProResponse")
    @WebResult(name = "getWeatherbyCityNameProResult", targetNamespace = "http://WebXml.com.cn/")
    public com.steelman.iot.platform.weather.webxml.ArrayOfString getWeatherbyCityNamePro(
    ...
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetSupportCityResponse")
    @WebResult(name = "getSupportCityResult", targetNamespace = "http://WebXml.com.cn/")
    public com.steelman.iot.platform.weather.webxml.ArrayOfString getSupportCity(
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetSupportDataSetResponse")
    @WebResult(name = "getSupportDataSetResult", targetNamespace = "http://WebXml.com.cn/")
    public com.steelman.iot.platform.weather.webxml.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet()
;
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.steelman.iot.platform.webxml.GetWeatherbyCityNameResponse")
    @WebResult(name = "getWeatherbyCityNameResult", targetNamespace = "http://WebXml.com.cn/")
    public com.steelman.iot.platform.weather.webxml.ArrayOfString getWeatherbyCityName(
