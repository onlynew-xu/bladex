...
@Service("mT300CDeviceRemoteService")
public class MT300CDeviceRemoteService extends BaseService {
    ...
    public Boolean setDeviceParameter(String serialNum, DeviceParamsSmartElec deviceParamsSmartElec) throws Exception{
        ...
        if(!StringUtils.isBlank(serialNum)){
            ...
            urlBuf.append("/ea/channel/setDeviceParameter/");
            ...
            if(StringUtils.isNotBlank(ctRatioA)&&StringUtils.isNotBlank(ctRatioB)&&StringUtils.isNotBlank(ctRatioC)){
