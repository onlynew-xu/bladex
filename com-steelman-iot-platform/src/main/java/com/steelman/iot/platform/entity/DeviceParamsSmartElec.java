...
public class DeviceParamsSmartElec implements Serializable {
     ...
     * 漏电,单位：mA
     */
    @ApiModelProperty(value = "漏电,单位：mA")
    private String overLeaked;

    /**
     * 过温,单位：0.1°C
     */
    @ApiModelProperty(value = "过温,单位：0.1°C")
