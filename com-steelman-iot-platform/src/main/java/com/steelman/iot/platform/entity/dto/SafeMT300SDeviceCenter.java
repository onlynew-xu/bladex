...
@NoArgsConstructor
@AllArgsConstructor
public class SafeMT300SDeviceCenter implements Serializable {
    ...
    private Map<String,Object> wenDu =new LinkedHashMap<>();
    private Map<String,Object> dianYa=new LinkedHashMap<>();
    private Map<String,Object> dianLiu=new LinkedHashMap<>();
    private Map<String,Object> louDianLiu=new LinkedHashMap<>();
